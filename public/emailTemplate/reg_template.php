                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;">
                                            <strong style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Email</strong>{user_email}
                                            <strong style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Password</strong>{user_password}
                                        </p>
                                        <a href="{login}" style="background:#20e277;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Login
                                            to your Account</a>
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;text-align: left !important;">
                                            If you have any questions or need assistance, please don't hesitate to contact us.
                                        </p>
                                        <p style="font-size:16px; color:#455056;line-height:24px;text-align: left!important;font-weight: 600!important;margin-bottom: 0 !important;">
                                            Best regards 
                                        </p>
